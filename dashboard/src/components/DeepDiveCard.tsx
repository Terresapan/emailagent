    ...
    return (
      <div className="glass-card flex h-full min-h-[400px] flex-col rounded-xl p-6">
        <div className="mb-4 flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-white">Weekly Deep Dive</h3>
        </div>
        <div className="flex flex-1 items-center justify-center">
          <p className="text-gray-500">No deep dive available</p>
        </div>
      </div>
    );
  }
        ...
        <div className="prose-dark">
          <ReactMarkdown
            components={{
              ...
              h3: ({ children }) => (
                <h3 className="mt-4 first:mt-0 mb-2 text-base font-semibold text-indigo-400">
                  {children}
                </h3>
              ),
              ul: ({ children }) => (
